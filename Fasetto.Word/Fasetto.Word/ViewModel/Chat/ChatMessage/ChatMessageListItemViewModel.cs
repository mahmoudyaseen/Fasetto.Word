...
namespace Fasetto.Word
{
    ...
    {
        /// <summary>
        /// The display name of the sender of message
        /// </summary>
        ...
        /// <summary>
        /// The time that message was read in, or <see cref="DateTimeOffset.MinValue"/> if not read
        /// </summary>
        ...
        /// <summary>
        /// The time that message was sent in
        /// </summary>
