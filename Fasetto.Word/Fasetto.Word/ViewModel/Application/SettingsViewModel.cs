...
namespace Fasetto.Word
{
    ...
    public class SettingsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Indicates if the user name is current being saved
        /// </summary>
        ...
        /// <summary>
        /// Indicates if the settings details are currently being loading
        /// </summary>
        ...
        public SettingsViewModel()
        {
            ...
            FirstName = new TextEntryViewModel
            {
                ...
                ComitAction = SaveFirstNameAsync
            };
            // Create LastName
        ...
        public async Task LogoutAsync()
        {
            ...
            await RunCommandAsync(() => LoggingOut, async () =>
            {
                ...
                // Clean all application level view models that contains
        ...
        public async Task<bool> SavePasswordAsync()
        {
            ...
            return await RunCommandAsync(() => PasswordIsChanging, async () =>
            {
                ...
                // Get the current knowm credentials
                ...
                if (Password.NewPassword.Unsecure() != Password.ConfirmPassword.Unsecure())
                {
                    ...
                    await UI.ShowMessage(new MessageBoxDialogViewModel
                    {
                        ...
                        Message = "New password and confiem password must match"
                    });
                ...
                {
                    // Log it
                    Logger.LogDebugSource($"Failed to update password. {result.ErrorMessage}");

                    // Return false
                    return false;
                }

                // Otherwise, we success

                // Log it
                Logger.LogDebugSource("Successfully change password");
        ...
        private async Task<bool> UpdateUserCredentialsValueAsync(string displayName,
                                                                 Expression<Func<LoginCredentialsDataModel,
                                                                 ...
                                                                 Action<UpdateUserProfileApiModel, string> setApiModel)
        {
            ...
            // Update the setver with the details
            var result = await WebRequests.PostAsync<ApiResponse>(
                // Set Url
            ...
            // Log it
            Logger.LogDebugSource("Successfil update First name, Saving to local database cach...");
