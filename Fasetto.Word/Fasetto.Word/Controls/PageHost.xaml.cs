...
namespace Fasetto.Word
{
    ...
    public partial class PageHost : UserControl
    {
        ...
        /// </summary>
        /// and this the way to make a dependency property propdp+2 tabs to automatically write this
        ...
        private static object CurrentPagePropertyChanged(DependencyObject d, object value)
        {
            ...
            // If the current page hasn't change
            ...
            if (oldPageContent is BasePage oldPage)
            {
                ...
                // it will make a new thread
                Task.Delay((int)(oldPage.SlideSeconds * 1000)).ContinueWith((t) =>
                {
                    // Remove old page
                    // return on the main thread to update ui
            ...
            // Then UI thread will work and update the view,
            // because we put new page in old page frame(other frame) so the page will load again
            // so we need this page to animate out in load
            // so we make a flag tell us if we want to animate in or out in load
        }
